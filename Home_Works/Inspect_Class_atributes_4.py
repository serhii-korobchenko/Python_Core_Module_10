...
control_level = 0
def inspect_class_obj (obj, level_in = 7):
    ...
    if len(inspect.getmembers(obj)) == 0: # base case
        ...
        print (f'Maximum depth level = {control_level}, has been reached!')
        ...
        for i in inspect.getmembers(obj):
            ...
            if type(i) == tuple:
                ...
                if not i[0].startswith('_'):
                    ...
                    #if not 'method' in (i[1]): 
                    print(f'Object ***{i[0]}*** contains links for {len(inspect.getmembers(i))} atributes')
                    control_level +=1
                    return inspect_class_obj (i)   


inspect_class_obj (armaments_1)
